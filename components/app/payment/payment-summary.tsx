    ...
    <Card className="w-full md:w-1/2 shadow-lg border-2 border-muted bg-white/90 flex flex-col tracking-wider">
      <CardHeader className="">
        <CardTitle className="text-4xl font-bold ">
          <span className="tracking-wider">US$32.66</span>
      ...
      <CardContent className="flex-1">
        <Card className="my-6 border px-4 py-12 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <div className="font-medium text-xl mb-1">Pro Plan Monthly</div>
            <div className="text-muted-foreground text-lg">US$32.66/month</div>
          </div>
        </Card>
      </CardContent>
      <CardFooter>
        <div className="flex flex-col justify-between bg-white rounded-lg p-4 border w-full">
          <div className="space-y-4">
            <div className="flex justify-between">
              ...
              <span className="tracking-widest">US$30.00</span>
            </div>
            <div className="flex justify-between">
              <span className="text-muted-foreground">Tax</span>
              <span className="tracking-widest">US$2.66</span>
            </div>
          </div>
          <div className="flex justify-between font-bold text-xl mt-4 border-t pt-3">
            <span>Total</span>
            <span className="tracking-widest">US$32.66</span>
          </div>
        </div>
      </CardFooter>
    </Card>
